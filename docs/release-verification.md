...
Windows Authenticode and Apple notarization are deferred for the v0.2 preview. Windows SmartScreen and macOS Gatekeeper may therefore show an operating-system warning even when checksum and Sigstore verification succeed.
